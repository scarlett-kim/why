...
public class BoardDao {   
   ...
   public int editBoard(Board board) {   //글 수정
      ...
      System.out.println("editBoard야 됐니? " + resultrow);
      return resultrow;
   }
   ...
   public ArrayList<File> showcurrentreview(int bcode) {   // 최근 후기 5개 메인에 보여줄 것. (인영)
	      ...
	      String sql = "select b.id, b.writedate, b.title, b.readnum, f.savename from board b join fileupload f on b.idx = f.idx where bcode=? and rownum <=5 ORDER BY writedate desc";
